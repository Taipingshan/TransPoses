...
class LpmsB2(object):
    ...
    def set_filter_mode(self):
        if not self.is_connected():
            ...
            return False
        self.set_command_mode()
        if self.verbose: logd(self.TAG, "Set filter mode")
        self.__lpbus_set_none(LPMS_SET_FILTER_MODE)
        self.wait_for_ack = True
        self.__wait_for_response()
    ...
    def set_stream_frequency_120Hz(self):
        self.set_stream_frequency(LPMS_STREAM_FREQ_120HZ)
