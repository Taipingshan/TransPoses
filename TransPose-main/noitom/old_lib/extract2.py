...
# 选择需要保存的列
selected_columns = ['RightForeArm-Sensor-Acce-x', 'RightForeArm-Sensor-Acce-y', 'RightForeArm-Sensor-Acce-z',
                    'RightForeArm-Sensor-Gyro-x', 'RightForeArm-Sensor-Gyro-y', 'RightForeArm-Sensor-Gyro-z']  # 替换为你需要保存的列名
